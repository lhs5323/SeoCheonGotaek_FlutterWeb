    ...
    Container(
        ...
        child: Stack(children: <Widget>[
          SvgPicture.asset('assets/images/home_bg_2.svg',
              width: screenwidth, height: screenheight, fit: BoxFit.fitHeight),
          Center(
              child: Column(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "'함부로 나뭇가지를 치지 마라.'\n -청암 이하복 선생",
                    textAlign: TextAlign.center,
                    style: Responsive.isMobile(context) ? TextStyle(fontSize: 12) : TextStyle(fontSize: 18),
                  ),
                  Spacer(),
                  ...
                  Text(
                    "충남 서천군 기산면 신산리에 위치한 서천 이하복 고택은 우리나라 중부지방의 전통농가 형태를 \n "
                        ...
                        "1984년 12월 24일 국가 민속자료 제 197호로 지정되었습니다.",
                    textAlign: TextAlign.center,
                    style: Responsive.isMobile(context) ? TextStyle(fontSize: 9) : TextStyle(fontSize: 18),
                  ),
                  Spacer()
                ],
              ))
